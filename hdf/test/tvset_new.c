...
test_vglongnames(void)
{
    ...
    VERIFY_VOID(name_len, strlen(VG_LONGNAME), "Vgetnamelen");
 ...
 */ 
    ...
    status = Vgetnamelen(vg1, &name_len);
    CHECK_VOID(status, FAIL, "Vgetnamelen");
    VERIFY_VOID(name_len, strlen(VGROUP1), "Vgetname");
    ...
    statusint = Vgetclass(vg1, vgclass, &buf_size);
    CHECK_VOID(statusint, FAIL, "VSgetclass");
    VERIFY_VOID(buf_size, strlen(VG_LONGCLASS), "Vgetname");
